...
const (
	...
	UserServiceName = "pixelfs.v1.UserService"
)
...
const (
	...
	UserServiceGetUserInfoProcedure = "/pixelfs.v1.UserService/GetUserInfo"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	userServiceServiceDescriptor           = v1.File_pixelfs_v1_user_proto.Services().ByName("UserService")
	userServiceGetUserInfoMethodDescriptor = userServiceServiceDescriptor.Methods().ByName("GetUserInfo")
)

// UserServiceClient is a client for the pixelfs.v1.UserService service.
type UserServiceClient interface {
	GetUserInfo(context.Context, *connect.Request[v1.GetUserInfoRequest]) (*connect.Response[v1.GetUserInfoResponse], error)
}

// NewUserServiceClient constructs a client for the pixelfs.v1.UserService service. By default, it
...
// GetUserInfo calls pixelfs.v1.UserService.GetUserInfo.
...
// UserServiceHandler is an implementation of the pixelfs.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/pixelfs.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) GetUserInfo(context.Context, *connect.Request[v1.GetUserInfoRequest]) (*connect.Response[v1.GetUserInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pixelfs.v1.UserService.GetUserInfo is not implemented"))
}
